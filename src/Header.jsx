    ...
    <>
      <div className="top-bar" id="home">
        <div className="container">
          <span>
            <a href="tel:+919114036376"><i className="fas fa-phone-alt"></i> +91 91140 36376</a>
          </span>
          <span>
          ...
          <nav>
            <ul id="nav-links" className={menuOpen ? 'active' : ''}>
              ...
              <li className="dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><a href="#" onClick={closeMenu}>AI & Robotics Lab CBSE </a></li>
                  <li><a href="#" onClick={closeMenu}>AI & Robotics Lab ICSE</a></li>
                  ...
                  <li><a href="#" onClick={closeMenu}>Pre Tinkering Lab</a></li>
              ...
              <li><a href="#franchise" onClick={(e) => handleAnchorClick(e, '#franchise')}>Franchise</a></li>
